...
function init() {
	...
	_initExtent = new esri.geometry.Extent({"xmin":-15008256,"ymin":205269,"xmax":5029252,"ymax":9636987,"spatialReference":{"wkid":102100}});
...
function handleWindowResize() {
	...
	setTimeout(function(){
		$("#tableControls").width($("#woodPane").width());
		$("#tableControls").css("margin-left",($(window).width() - $("#tableControls").width())/2);
	},100);
