function YouTubeRequest(type,tags) {
	...
	this.execute = function() {
		...
		$.getJSON(url, function(data){
			...
			console.log('YouTube not loading...')
			_complete = true;
	...
	function buildURL(tags) {
		return "https://gdata.youtube.com/feeds/api/videos?q="+tags+"&orderby=published&max-results=50&location=37.42307,-122.08427!&location-radius=1000km&v=2&alt=json"
	}
